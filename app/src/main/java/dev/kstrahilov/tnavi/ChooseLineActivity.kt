...
class ChooseLineActivity : AppCompatActivity(), OnItemClickListener {
    ...
    private fun data(): ArrayList<Line> {
        ...
        route821.add(Stop("ТИС Север /до ТЦ за ЖПГ/", false, false, null, null))
        ...
        route821.add(Stop("В. Ханчев", false, false, null, null))
        ...
        route821.add(Stop("ЖПГ /пл. Славейков за КК/", false, false, null, null))

        val route822: ArrayList<Stop> = ArrayList()
        route822.add(Stop("ЖПГ /пл. Славейков за център/", false, true, null, null))
        ...
        route822.add(Stop("Дом Младост за /Вл-во/", false, false, null, null))
        route822.add(Stop("Георги Петлешев", false, false, null, null))
        route822.add(Stop("Петя Дубарова", false, false, null, null))
        route822.add(Stop("В. Ханчев", false, false, null, null))
        ...
        route823.add(Stop("ЖПГ /пл. Славейков за център/", false, true, null, null))
        route823.add(Stop("Димчо Дебелянов", false, false, null, null))
        route823.add(Stop("Централна поща", false, false, null, null))
        route823.add(Stop("Нептун", false, false, null, null))
        route823.add(Stop("Л.к. Тракия", false, false, null, null))
        route823.add(Stop("Трансформатора", false, false, null, null))
        route823.add(Stop("Техникумите-Сливница", false, false, null, null))
        route823.add(Stop("8-ми септември", false, false, null, null))
        route823.add(Stop("Дом Младост за /Вл-во/", false, false, null, null))
        route823.add(Stop("Георги Петлешев", false, false, null, null))
        route823.add(Stop("Петя Дубарова", false, false, null, null))
        route823.add(Stop("В. Ханчев", false, false, null, null))
        route823.add(Stop("Мебелна палата", false, false, null, null))
        ...
        route831.add(Stop("ЖПГ /пл. Славейков за КК/", false, false, null, null))

        val route832: ArrayList<Stop> = ArrayList()
        route832.add(Stop("ЖПГ /пл. Славейков/", false, true, null, null))
